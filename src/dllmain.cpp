...
/*
* ZBK BOT V4 [FINAL]
- Добавлена автоматическая отправка денег на другой акк (настройка с конфига)
+ Исправлен баг с уходом в афк во время длительного застоя камеры
- Авто-ответчик был вырезан ввиду его неэффективности
- Добавлен конфиг для настройки бота
*/
